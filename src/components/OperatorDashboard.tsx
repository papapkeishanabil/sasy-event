  ...
  return (
    <div className="page-transition min-h-screen flex flex-col bg-sasie-cream">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-20 right-3 w-10 h-10 rounded-full bg-sasie-gold/90 backdrop-blur-sm shadow-md flex items-center justify-center z-[100] hover:bg-sasie-gold transition-all duration-200"
          aria-label="Scroll to top"
        >
          <svg className="w-5 h-5" fill="none" stroke="white" strokeOpacity="0.6" viewBox="0 0 24 24">
